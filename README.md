Данный проект представляет собой легкую в использовании реализацию игры "Крестики-нолики" с использованием библиотеки aiogram для написания ботов. Проект обладает широким спектром возможностей:
